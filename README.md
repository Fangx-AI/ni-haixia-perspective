...
把症状、检查报告、方剂名、医案或视频链接发给它。它不会先介绍自己有什么功能，而会直接告诉你：**倪海厦会怎样判断、关键要看什么、什么情况不能拖。**

| 你问 | 它会直接这样回答（节选） |
|---|---|
| “我怕冷、没汗、后颈发紧，怎么理解？” | “先往太阳伤寒看，但还不能定麻黄汤。还要看身体痛不痛、喘不喘、口渴不口渴，脉是浮紧还是浮缓。” |
| “这份血常规和肝功能有什么问题？” | “先看具体数值偏了多少，是一项变了还是几项一起变，再和以前的结果比较。把报告、单位、参考范围和正在吃的药发来，我先告诉你哪项最该处理。” |
| “小柴胡汤到底什么情况才讨论？” | “不是口苦就用小柴胡汤。往来寒热、胸胁苦满、心烦想吐、胃口下降要成组出现；表证还在或已经里热，方都会变。” |
| “生附子和炮附子有什么区别？” | “不能只背成一个救急、一个补阳。它们放进不同的寒证和方证里看；附子有毒，课程可以讲，但不能照视频自己定量煮。” |
| “每天凌晨一到三点醒，是肝不好吗？” | “时辰只是线索，不是肝病诊断。先分清你是热醒、烦醒、痛醒还是憋醒，再看饮酒、药物、打鼾和白天精神。” |
| “癌症能不能照倪海厦医案吃药？” | “不能照抄。医案教你辨证，不是给同一病名的人共用一张方；病理、分期、体力、二便和正在做的治疗不同，处理就不同。” |
| “这个B站切片里的处方是真的吗？” | “先别信标题。切片只能算线索；必须找到完整课程和时间点，确认原话、前后文和适用条件，才能判断这张处方是不是被断章取义。” |

> 它不会替你远程开方、定剂量或教你自行扎针。但它必须把话说明白：**现在急不急、主要往哪里判断、还缺哪几个信息、你接下来该做什么。**

## 这套 Skill 里实际有什么

| 知识层 | 内容 | 回答中的作用 |
|---|---|---|
| 速查层 | 六经总表、相近方区别、问诊清单、安全规则 | 先判断该往哪个方向讲 |
| 医学模块 | 六经、经方、黄帝内经、金匮、本草针灸、重病、高频问答 | 直接解释症状、方证和医案 |
| 医案层 | 581 条去重医案与临床日志 | 按病名找公开病例，并打开原文核对 |
| 出处层 | 8,058 条来源、300 条高传播视频、10 个时间戳包、18 条重点说法 | 查清“他到底说没说、在什么上下文说的” |
| 安全层 | 急症和用药风险规则 | 该急诊时先说急诊，不把历史医案当处方 |

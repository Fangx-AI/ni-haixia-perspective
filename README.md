...
| 你的问题 | Skill 会给你的帮助 |
|---|---|
| “这个复杂选择该怎么判断？” | 先写正常态和目标，再用2–4个模型分析矛盾、环境、反馈与行动顺序 |
| “倪海厦真的说过这句话吗？” | 给出来源等级、可定位出处、归属置信度，并区分原话、释义和未核切片 |
| “我应该怎样系统学习，而不是刷短视频？” | 从经典操作系统和传承工程化出发，设计原典—课程—实践—复盘路径 |
| “怎样把复杂概念讲得让普通人懂？” | 使用可见比喻、因果链和强结论结构，同时标出比喻失效的位置 |
| “倪海厦对某个医学问题怎么看？” | 分层呈现历史观点与当前权威证据，不把人物观点变成现实处方 |
| “这套观点有哪些漏洞？” | 主动展示反证、内在张力、来源依赖和模型的适用边界 |

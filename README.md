...
它首先是一名**医学信息助手**：帮你判断问题有多急，把症状和报告整理成可讨论的临床图景；再用倪海厦公开课程中的六经、寒热虚实、方证和医案解释；最后补上当前医学的鉴别、证据和安全行动。
...
```text
我昨天开始怕冷、没有汗、后颈很紧，还有轻微发热。请先判断是否需要马上就医，再按倪海厦公开课程分析可能的辨证候选，并用现代医学补充鉴别。还缺什么信息就问我。
```
...
以下是缩略示例，不构成对任何人的诊断或处方。完整回答会结合年龄、病程、基础病、用药和最新权威资料。

### 1. 怕冷、无汗、后颈痛，是不是麻黄汤证？

> **先看风险**：如果同时出现高热、剧烈头痛、颈部僵硬到低头困难、意识异常、呼吸困难或胸痛，应优先急诊评估。
>
> **倪氏辨证候选**：怕冷、无汗、项背紧与其伤寒课程中的“太阳表实”候选有相似处，但仅凭三项不能确定方证。还需区分体温、身体疼痛、咳喘、口渴、汗出变化、脉象、年龄与基础病，也要和太阳中风、温病及少阴候选比较。
>
> **现代医学视角**：常见原因包括呼吸道感染或肌肉紧张；若有上述神经系统或呼吸循环危险信号，需要排除更严重问题。Skill 会继续问最能改变判断的几个问题，而不是直接让你自行服方。

### 2. 总在凌晨一点到三点醒，是肝有问题吗？

> **不能仅凭醒来的时辰判断肝病。** Skill 会说明倪海厦公开教学如何把睡眠和时辰纳入整体观察，但不会把这个对应关系当作现代诊断。现实中还要看持续多久、能否再入睡、打鼾憋醒、饮酒咖啡因、情绪、药物、疼痛和白天功能；必要时再讨论睡眠呼吸障碍、焦虑抑郁、甲状腺或其他因素的评估方向。

### 3. 体检有几个箭头，但人没有不舒服，需要管吗？

> Skill 不会逐项翻译“偏高/偏低”就结束。它会先找可能需要尽快处理的异常，再看单位、参考范围、偏离幅度、相关指标组合和历年趋势；随后解释常见原因、哪些情况需要复查或门诊，以及复诊时应该带上哪些用药、饮食和既往数据。倪海厦强调的睡眠、胃口、排泄等整体观察可以作为补充，但不能覆盖实验室和影像结果。

### 4. 小柴胡汤什么时候用？我这种情况能不能用？

> Skill 可以讲少阳方证的课程逻辑、关键症状组合、与相近方证的区别，以及方中药物怎样配伍；如果问题涉及你本人，则会继续核对症状、基础病、妊娠可能、正在使用的药物和危险信号。它不会仅凭“口苦”或“往来寒热”就给出个人处方、剂量和疗程。

### 5. 生附子、炮附子是不是一个救急、一个补阳？

> Skill 会把倪海厦课程中的历史区分、相关方证和原始出处说明白，同时指出附子类药材存在显著毒性，炮制、来源、剂量、合并用药和个体状况都会改变风险。可以学习其理论和医案，但不能据此自行购买、炮制或试药。

### 6. 癌症患者能不能照倪海厦医案用药？

> **不能把公开医案直接复制成治疗方案。** Skill 可以帮你读懂该医案的辨证、用药思路、出处和证据缺口，也会把人物观点与当前肿瘤证据分开；进一步帮助整理症状、治疗阶段、副作用和希望向肿瘤团队询问的问题。它不会建议停掉、推迟或替换手术、放疗、化疗、靶向、免疫或其他标准治疗。

## 每次医学回答的三层结构

```mermaid
flowchart LR
    A[症状 / 报告 / 方剂 / 疾病] --> B[风险分级]
    B --> C[倪氏辨证与方证候选]
    B --> D[当前医学鉴别与证据]
    C --> E[支持点 / 冲突点 / 缺失信息]
    D --> E
